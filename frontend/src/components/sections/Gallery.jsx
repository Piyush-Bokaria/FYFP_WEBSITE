                ...
                <div className="gallery-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {items.map((item, index) => (
                        <a href={item.link} target="_blank" rel="noopener noreferrer">
                            <div key={index} className="gallery-item aspect-square rounded-2xl bg-white relative overflow-hidden group shadow-sm hover:shadow-card transition-all duration-300">
